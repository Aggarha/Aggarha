const en = {
  ...
  profile: {
    ...
    levelLabel: "Level",
    xpLabel: "XP",
    levelPerkNote: "The more active you are, the higher your listings appear on the home page.",
    achievementsTitle: "Achievements",
    achievementsCount: (count: number) => (count === 1 ? "1 achievement" : `${count} achievements`),
    ...
    bookingsEmptyHint: "Rentals and swaps you request show up here.",
    reviewsEmpty: "No reviews yet",
    reviewsEmptyHint: "Reviews from people you've dealt with show up here.",
    requestsEmpty: "No incoming requests",
    requestsEmptyHint: "When someone asks to rent or swap your item, it lands here.",
    accept: "Accept",
    decline: "Decline",
    memberSinceYear: (year: string) => `Member since ${year}`,
